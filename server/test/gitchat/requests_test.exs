defmodule Gitchat.RequestsTest do
  ...
  describe "requests" do
    ...
    @valid_attrs %{invitee: "some invitee"}
    @update_attrs %{invitee: "some updated invitee"}
    ...
    test "create_request/1 with valid data creates a request" do
      ...
      assert request.invitee == "some invitee"
    end
    ...
    test "update_request/2 with valid data updates the request" do
      ...
      assert request.invitee == "some updated invitee"
    end
